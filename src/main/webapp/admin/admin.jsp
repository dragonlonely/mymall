		...
		<div class="page_main">
			<script type="text/javascript">
				...
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/goods/getgoodstype.action");
				})
				...
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/goods/getgoodslist.action");
				})
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/admin/addGoods.jsp");
				})
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/order/getallorder.action");
				})
			</script>
